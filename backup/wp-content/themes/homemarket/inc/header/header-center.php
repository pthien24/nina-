<header id="center-header" class="site-header">
		...
		<div id="main-header" class="grid--full grid--table">
			...
			<div class="mobile-logo grid__item small--one-whole medium--one-whole two-eighths text-center">
				...
				?>
					...
					<div class="site-header__logo" rel="home" itemscope="" itemtype="http://schema.org/Organization">
			...
			?>
				...
				<h1 class="site-header__logo" rel="home" itemscope="" itemtype="http://schema.org/Organization">
					<a href="<?php echo esc_url(home_url( '/' )); ?>" itemprop="url" class="site-header__logo-link">
						<img src="<?php echo esc_url($logo_url); ?>" alt="<?php bloginfo('name'); ?>" itemprop="logo">
					</a>
				</h1>
...
<!-- Navigation Bar -->
<nav id="center-nav" class="nav-bar" role="navigation">
	<div class="wrapper">
