<header id="rightbox-header" class="site-header">
							...
							<?php if ( (isset($homemarket_theme_options['main_header_shopping_cart'])) && ($homemarket_theme_options['main_header_shopping_cart'] == "1" ) ): ?>
								...
								<div class="site-nav--mobile">
									<div class="header-cart">
										<a href="<?php echo esc_url($woocommerce->cart->get_cart_url()); ?>" class="site-header__cart-toggle js-drawer-open-right">
...
<!-- Navigation Bar -->
<nav id="rightbox-nav-bar" class="nav-bar" role="navigation">
	<div class="wrapper">
		<div class="medium-down--hide">
			<div class="menu-container">
				<div class="shop-by-collections always-show grid__item one-quarter">
					<div class="sidebar-collections">
						<div class="sdcollections-title sb-title">
							<i class="fa fa-list"></i>
							<span><?php _e('All Collections', 'homemarket'); ?></span>
						</div>
						<div class="sdcollections-content">
							<?php
								$walker_collection = new rc_scm_walker_collection;
								wp_nav_menu(array(
				                    'theme_location'  => 'collections-navigation',
				                    'fallback_cb'     => false,
				                    'container'       => false,
				...
				<?php
					...
					wp_nav_menu(array(
	                    ...
	                    'fallback_cb'     => false,
	                    'container'       => false,
	                    'items_wrap'      => '<ul id="AccessibleNav" class="%1$s site-nav grid__item three-quarters">%3$s</ul>',
						'walker'          => $walker
	                ));
				?>
			</div>
