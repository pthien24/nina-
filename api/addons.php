    ...
    <?php if(count($videonb)>0){ ?>
        <div class="h-l-v">
            <?php for($i=0;$i<count($videonb);$i++){ ?>
                <div class="item-video">                    
                    ...
                    <img onerror="this.src='<?=THUMBS?>/685x400x2/assets/images/noimage.png';" src="<?=THUMBS?>/685x400x1/<?=UPLOAD_PHOTO_L.$videonb[$i]['photo']?>" alt="<?=$videonb[$i]['name'.$lang]?>" />
                    </a>
                </div>
            <?php } ?> 
        </div>
        <div class="h-r-v">
            <?php for($i=0;$i<count($videonb);$i++){ ?>
                <div class="item-duoi clearfix">
                    <a>                     
                        <img onerror="this.src='<?=THUMBS?>/110x56x2/assets/images/noimage.png';" src="<?=THUMBS?>/110x56x1/<?=UPLOAD_PHOTO_L.$videonb[$i]['photo']?>" alt="<?=$videonb[$i]['name'.$lang]?>" />
                    </a>
                </div>
            <?php } ?>    
        </div>
...
if ($type == 'fanpage-facebook') { ?>
    <div class="fb-page" data-href="<?= $optsetting['fanpage'] ?>" data-tabs="timeline" data-width="300" data-height="166" data-small-header="true" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
