...
$config['product'][$nametype]['check'] = array("banchay" => "Bán chạy","noibat" => "Nổi bật", "hienthi" => "Hiển thị");//, "moi" => "Mới", "banchay" => "Bán chạy"
...
$config['product'][$nametype]['width'] = 259;
$config['product'][$nametype]['height'] = 259;
...
$config['product'][$nametype]['width2'] = 259;
$config['product'][$nametype]['height2'] = 259;
