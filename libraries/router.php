...
$requick = array(
    ...
    /* Trang tĩnh */
    array("tbl" => "static", "field" => "id", "source" => "static", "com" => "gioi-thieu", "type" => "gioi-thieu", "menu" => true, "priority" => 0.80),
    array("tbl" => "static", "field" => "id", "source" => "static", "com" => "chinh-sach-si", "type" => "chinh-sach-si", "menu" => true, "priority" => 0.80),
