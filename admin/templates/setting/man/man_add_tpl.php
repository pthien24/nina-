                ...
                <div class="row">
                    ...
                    <?php if (isset($config['setting']['chiduong']) && $config['setting']['chiduong'] == true) { ?>
                        <div class="form-group col-md-4 col-sm-6">
                            ...
                            <input type="text" class="form-control text-sm" name="data[options][chiduong]" id="chiduong" placeholder="Chỉ đường" value="<?= (!empty($flash->has('chiduong'))) ? $flash->get('chiduong') : @$options['chiduong'] ?>">
                        </div>
                    <?php } ?>
